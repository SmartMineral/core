...
import SmartMineralMiner from './smartmineral_miner';

import SimpleConsole from './simple-console';

var SmartMineral = contract(smartmineral_artifacts);
var accounts;
var account;
...
window.App = {
    start: function() {
        ...
        SmartMineral.setProvider(web3.currentProvider);
        ...
        web3.eth.getAccounts(function(err, accs) {
            ...
            console.log("Starting SmartMineral Miner...");
    ...
    setupWebConsole: function() {
        var con = new SimpleConsole({
            ...
            storageID: "SmartMineral-miner"
        });
        document.body.appendChild(con.element);

        con.logHTML(
            "<h1>SmartMineral Console Miner 0.38 </a></h1>"
        );


        self.miner = new SmartMineralMiner(account, con.log);
        ...
        function handle_command(command) {
            ...
            if (command.match(/^(stats?|statistics?)/i)) {
                ...
                con.log("SmartMineral Miner Help ");
                ...
                con.log("claim blocknumber -- Try to force claim a SmartMineral Block");
